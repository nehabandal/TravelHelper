 ...
 *
 * Recommended:
 * 1. Recommend hotels with rating 4 and above
 * 2. Recommend saved hotels
 */

@SuppressWarnings("serial")
public class ShowRecomendedHotelsServlet extends BaseServlet {

    private DatabaseConnector db;
    private String FETCH_HOTELS_SQL =
            "select hotelData.hotelId,hotelData.hotelName,hotelData.address,hotelData.city, hotelData.state, hotelData.country, avg(rating) as avgRating from hotelData " +
                    "LEFT JOIN reviewData on hotelData.hotelId=reviewData.hotelId " +
                    "group by(hotelData.hotelId) " +
                    "HAVING avgRating >= 4.5;";

    public ShowRecomendedHotelsServlet() {
        try {
    ...
    public Template handleRequest(HttpServletRequest request,
        ...
        context.put("heading", "Recommended Hotels");
