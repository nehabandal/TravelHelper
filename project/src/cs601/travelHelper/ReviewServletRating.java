 ...
 */
public class ReviewServletRating extends BaseServlet {

    public static final String REVIEW_QUERY_SQL = "select reviewTitle,review,username,rating,date from reviewData where hotelId= ? order by rating DESC ";

    private DatabaseConnector db;

    public ReviewServletRating() {
        try {
    ...
    public Template handleRequest(HttpServletRequest request,
        ...
        Template template = ve.getTemplate("web/templates/hotel_detail_rating.vm");
